                ...
                <form id="form-add-consultation">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <select class="form-control custom-select" id="patient" name="patient" required>
                                <option value="" disabled selected>-- Memuat Data Pasien --</option>
                            </select>
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            <label for="online_session_id" class="font-weight-bold">Sesi Dokter <span
                                    class="text-danger">*</span></label>
                            <select class="form-control custom-select" id="online_session_id" name="online_session_id"
                                required>
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group mb-3">
                            <label for="start_time" class="font-weight-bold">Waktu Mulai <span
                                    class="text-danger">*</span></label>
...
@section('scripts')
    <script>
        $(document).ready(function () {
            function loadDropdowns() {
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            let patientSelect = $('#patient').empty().append('<option value="" disabled selected>-- Pilih Pasien --</option>');
            ...
            $('#form-add-consultation').on('submit', function (e) {
                e.preventDefault();
                let btn = $('#btn-submit');
                ...
                $.ajax({
                    url: '/api/admin/consultations/store',
                    method: 'POST',
                    processData: false,
                    contentType: false,
